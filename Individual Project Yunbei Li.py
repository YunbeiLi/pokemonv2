...
"""
Created on Mon Dec 04 17:14:54 2020
...
app.layout = html.Div([
    dcc.Tabs([
        ...
        children= [
    html.Div(children=['''
    Hello! Welcome to the Pokemon Dashboard.
    ''']),
    html.Div(children=['''
    ...
    amount of points, and the level of Attack, Defense and Speed. There are many pokemon to choose, 
    so pick wisely.
    ''']),
    html.Div(
        children=[
    ...
    children= [
        ...
        up in the graphs with the color pink. 
        ''']),
        html.Div(children=['''
